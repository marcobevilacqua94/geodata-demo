...
You can do it via quick index by adding loc as geopoint field and comune as a text field and istat as number. Select all the check options, apart from "index as id" for the comune. Call it comuniIndex.
